...
const demoRoles = [
  {
    label: "Admin",
    email: process.env.ROLE_QA_ADMIN_EMAIL ?? "admin@gmp.local",
  ...
  },
  {
    ...
    email: process.env.ROLE_QA_GOVERNANCE_EMAIL ?? "governance@gmp.local",
  ...
  {
    label: "Manager",
    email: process.env.ROLE_QA_MANAGER_EMAIL ?? "manager@gmp.local",
  ...
  {
    label: "Auditor",
    email: process.env.ROLE_QA_AUDITOR_EMAIL ?? "auditor@gmp.local",
  ...
  {
    label: "Board Member",
    email: process.env.ROLE_QA_BOARD_EMAIL ?? "board@gmp.local",
  ...
  },
  {
    ...
    email: process.env.ROLE_QA_PUBLIC_AUDITOR_EMAIL ?? "public-auditor@gmp.local",
